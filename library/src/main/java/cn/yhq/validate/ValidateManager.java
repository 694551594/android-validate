...
public class ValidateManager {
  ...
  public ValidateManager addValidateItem(EditText editText, ValidateItem item) {
    ...
    if (items == null) {
      ...
      items.validateItems = new ArrayList<ValidateItem>();
  ...
  public ValidateManager addValidatePhoneItem(EditText editText, String regex,
      String validateMessage) {
    addValidateItem(editText, ValidateType.REGEX, regex, validateMessage);
    return this;
  }
   ...
   * @return
   */
  public ValidateManager addValidateItem(EditText editText, ValidateType type, String validateRegex,
      String validateMessage) {
    addValidateItem(editText, ValidateItem.createRegexItem(type, validateMessage, validateRegex));
    return this;
  }
